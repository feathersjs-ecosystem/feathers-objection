...
class Service extends _adapterCommons.AdapterService {
  ...
  _update(id, data, params) {
    ...
    return this._get(id, params).then(oldData => {
      ...
      if (allowedUpsert) {
        return this.createQuery(params).allowUpsert(allowedUpsert).upsertGraphAndFetch(newObject, this.upsertGraphOptions);
  ...
  _patch(id, data, params) {
    ...
    if (allowedUpsert && id !== null) {
      ...
      return this.createQuery(params).allowUpsert(allowedUpsert).upsertGraphAndFetch(dataCopy, this.upsertGraphOptions);
    }
